...
def main():
    input_dir = 'c:/cia'  # Replace with the path to the directory containing .cia files
    output_dir = 'c:/cia/smdh'  # Replace with the path to save the extracted SMDH files
    num_threads = 4  # Number of threads to open for concurrent processing
